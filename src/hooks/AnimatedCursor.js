...
/**
 * AnimatedCursor
 * Conditionally renders the animated cursor or falls back to the default system cursor.
 */
function AnimatedCursor() {
  // Check if the device is any mobile or touch device
  if (typeof navigator !== 'undefined' && IsDevice.any()) {
    return null; // Return null to render nothing if on a mobile/touch device
  }

  // Return null to render nothing if not on a mobile/touch device
  return null;
}
